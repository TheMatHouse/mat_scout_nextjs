        ...
        <div className="flex items-start justify-between gap-4 mb-4">
          <div className="flex-1">
            ...
            {!nothingAtAll ? (
              ...
              <p className="text-sm text-foreground/60 mt-1">
                Any public matches reported by this user will be posted here.
              </p>
            )}
          </div>
          ...
          <div className="mb-4 rounded-2xl border border-border bg-background/60 px-4 py-3 shadow-sm">
            <div className="flex flex-wrap items-center gap-4 justify-between">
              <div className="flex flex-wrap items-center gap-4">
                <div>
                  <label className="mr-2 text-sm font-semibold">Style</label>
                  <select
                    value={selectedStyle}
                ...
                <div>
                  <label className="mr-2 text-sm font-semibold">Result</label>
                  <select
                    value={resultFilter}
