          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`
                  px-4 py-2 text-sm font-semibold rounded-t-md transition
                  focus:outline-none focus-visible:ring-2 focus-visible:ring-ms-blue
                  ${
                    isActive
                      ? "btn btn-primary" /* ACTIVE — your global styling */
