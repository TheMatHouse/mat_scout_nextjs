...
export default function Header() {
  ...
  if (loading) {
    return (
      <header className="w-full sticky top-0 z-50 bg-[#101630]shadow-sm h-20"></header>
    );
  }

  return (
    <header className="w-full sticky top-0 z-50 bg-[#101630] text-ms-nav-text  dark:text-white shadow-sm">
