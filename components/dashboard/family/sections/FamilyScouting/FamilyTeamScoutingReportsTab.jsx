...
const FamilyTeamScoutingReportsTab = ({ member }) => {
  ...
  // ------------------------------------------------------------------
  // Load ALL teams the *parent user* belongs to
  // ------------------------------------------------------------------
  useEffect(() => {
    if (!userId) return;
    ...
    (async () => {
      ...
      try {
        ...
        console.error("Error loading family teams:", err);
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-2">
          ...
          <p className="text-sm text-gray-900 dark:text-gray-100">
            These are teams this family member belongs to. Team scouting reports
            are owned by the team and may require a password.
          </p>
        </div>

        {teams.length === 0 ? (
          <p className="text-sm text-gray-900 dark:text-gray-100">
            No team scouting reports available yet.
          </p>
        ) : (
...
export default FamilyTeamScoutingReportsTab;
