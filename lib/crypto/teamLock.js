...
async function ensureTeamPassAndTbk(team, { allowGenerate = true } = {}) {
  ...
  // If TBK already cached, return it
  ...
  // Try unwrapping an existing TBK
...
/* ============================================================
   ENCRYPT COACH NOTE BODY  (TBK-based, NO wrapped key)
============================================================ */
export async function encryptCoachNoteBody(team, sensitiveBody) {
  ...
  return {
    ...
    crypto: {
      ...
      ivB64,
      ciphertextB64,
      wrappedReportKeyB64: "", // stays for scouting report compatibility
      teamKeyVersion,
    },
  };
}
...
/* ============================================================
   DECRYPT COACH NOTE BODY  (TBK-based)
============================================================ */
...
/* ============================================================
   CHANGE TEAM PASSWORD  (KEEP SAME TBK)
============================================================ */
